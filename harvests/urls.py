...
urlpatterns = [
    path("harvests/", views.harvests_list_view, name="harvests_list"),
    path("harvest/", views.harvest_view, name="harvest"),
    path("harvest/metadata/", views.harvest_metadata_view, name="harvest_metadata"),
    ...
    path("harvest/<int:harvest_id>/edit/", views.harvest_edit_view, name="harvest_edit"),
]
